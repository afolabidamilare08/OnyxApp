...
// import 'package:onyxswap/widgets/next_circular_button.dart';
...
// final _buyViewmodel = ChangeNotifierProvider.autoDispose(
//   (ref) => BuyViewModel(),
// );
...
//         ref.read(_buyViewmodel).startTimer());
//       // } else {
...
//   //   if (ref.read(_buyViewmodel).timer != null) {
//   //     ref.read(_buyViewmodel).timer!.cancel();
//   //   }
...
//                             // model.resetTimer();
//                             model.timer!.cancel();
//                             Navigator.popUntil(context,  ModalRoute.withName(NavigatorRoutes.homeView));
